...
function breadcrumbs() {
	...
	$homeText = esc_attr__('Home', 'dental-clinic');
	...
	if (is_single()) {
		...
		echo '<span>' . esc_html__('Search results for', 'dental-clinic') . ": '" . esc_html(get_search_query()) . "'</span>";
		...
		if (is_tax('post_format', 'post-format-aside')) {
			echo '<span>' . _x('Asides', 'post format archive title', 'dental-clinic') . '</span>';
		} elseif (is_tax('post_format', 'post-format-gallery')) {
			echo '<span>' . _x('Galleries', 'post format archive title', 'dental-clinic') . '</span>';
		} elseif (is_tax('post_format', 'post-format-image')) {
			echo '<span>' . _x('Images', 'post format archive title', 'dental-clinic') . '</span>';
		} elseif (is_tax('post_format', 'post-format-video')) {
			echo '<span>' . _x('Videos', 'post format archive title', 'dental-clinic') . '</span>';
		} elseif (is_tax('post_format', 'post-format-quote')) {
			echo '<span>' . _x('Quotes', 'post format archive title', 'dental-clinic') . '</span>';
		} elseif (is_tax('post_format', 'post-format-link')) {
			echo '<span>' . _x('Links', 'post format archive title', 'dental-clinic') . '</span>';
		} elseif (is_tax('post_format', 'post-format-status')) {
			echo '<span>' . _x('Statuses', 'post format archive title', 'dental-clinic') . '</span>';
		} elseif (is_tax('post_format', 'post-format-audio')) {
			echo '<span>' . _x('Audio', 'post format archive title', 'dental-clinic') . '</span>';
		} elseif (is_tax('post_format', 'post-format-chat')) {
			echo '<span>' . _x('Chats', 'post format archive title', 'dental-clinic') . '</span>';
		}
		...
		echo '<span>' . esc_html__('No breadcrumbs', 'dental-clinic') . '</span>';
	}
}
