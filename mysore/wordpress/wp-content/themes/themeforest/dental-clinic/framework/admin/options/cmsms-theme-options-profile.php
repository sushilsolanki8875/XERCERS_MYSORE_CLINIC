...
$cmsms_global_profile_post_details_title = (isset($cmsms_option[CMSMS_SHORTNAME . '_profile_post_details_title']) && $cmsms_option[CMSMS_SHORTNAME . '_profile_post_details_title'] !== '') ? $cmsms_option[CMSMS_SHORTNAME . '_profile_post_details_title'] : __('Profile details', 'dental-clinic');
...
$tabs_array['cmsms_profile'] = array( 
	'label' => esc_html__('Profile', 'dental-clinic'), 
	'value'	=> 'cmsms_profile' 
);
...
$custom_profile_meta_fields = array( 
	...
	array( 
		'label'	=> __('Profile Title', 'dental-clinic'), 
	...
	array( 
		'label'	=> __('Subtitle', 'dental-clinic'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Details Title', 'dental-clinic'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Social Icons', 'dental-clinic'), 
		'desc'	=> __('Add social icons for this profile', 'dental-clinic'), 
	...
	array( 
		'label'	=> __('Profile Info', 'dental-clinic'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 1 Title', 'dental-clinic'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 1', 'dental-clinic'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 2 Title', 'dental-clinic'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 2', 'dental-clinic'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 3 Title', 'dental-clinic'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 3', 'dental-clinic'), 
		'desc'	=> '', 
