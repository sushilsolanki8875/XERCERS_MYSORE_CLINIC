...
(function ($) { 
	$(document).ready(function () { 
		...
		if ($('input[name="cmsms_layout"]:checked').val() !== 'fullwidth') {
			...
			$('#cmsms_heading_block_disabled').closest('tr').hide();
		}
		...
		$('input[name="cmsms_layout"]').on('change', function () { 
			if ($(this).val() === 'fullwidth') {
				...
				$('#cmsms_heading_block_disabled').closest('tr').show();
		...
		if (
			$('#cmsms_header_overlaps').is(':checked') && 
			$('input[name="cmsms_layout"]:checked').val() === 'fullwidth'
		) {
			$('#cmsms_heading_block_disabled').closest('tr').show();
		}
		
		/* Heading Block Disabled Field Change */
		$('#cmsms_header_overlaps').on('change', function () { 
			if (
				$(this).is(':checked') && 
				$('input[name="cmsms_layout"]:checked').val() === 'fullwidth'
			) {
		...
		if (
			$('#cmsms_heading_block_disabled').is(':checked') && 
			$('#cmsms_header_overlaps').is(':checked') && 
			$('input[name="cmsms_layout"]:checked').val() === 'fullwidth'
		) {
			$('#cmsms_page_tabs > a[href="#cmsms_heading"]').hide();
		} else {
			$('#cmsms_page_tabs > a[href="#cmsms_heading"]').show();
		}
		
		/* Heading Block Title Change */
		$('#cmsms_heading_block_disabled').on('change', function () {
			if (
				$(this).is(':checked') && 
				$('#cmsms_header_overlaps').is(':checked') && 
				$('input[name="cmsms_layout"]:checked').val() === 'fullwidth'
