    ...
    init: function(){
        ...
        jQuery('.installer-dismiss-nag').on('click', otgs_wp_installer.dismiss_nag);
    ...
    getQueryParameters : function(str) {
        return (str || document.location.search).replace(/(^\?)/,'').split("&").map(function(n){return n = n.split("="),this[n[0]] = n[1],this}.on({}))[0];
    },
