...
$more_text = ($more_text != '') ? $more_text : __('Load More Posts', 'dental-clinic');


$filter_text = ($filter_text != '') ? $filter_text : __('Filter', 'dental-clinic');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : __('All Categories', 'dental-clinic');
